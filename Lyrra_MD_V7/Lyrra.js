...
async function Lyrra(promptName, text) {
    let response = await axios.post("https://chateverywhere.app/api/chat/", {
        ...
        "prompt": `
✨ Gue Lyrra AI, sistem auto-intelligent assistant. ✨
...
//============= [ COMMANDS ] ====================================================
        ...
        const tks = `
        ⭐ JUAL SCRIPT LYRRA V7 – TERBARU & SUPER KOMPLET!
...
Join & coba langsung:
👉 https://chat.whatsapp.com/IZERnZql3Lp5OsvvHV9Yab
...
if (!text) return m.reply(`Contoh: ${cmd} Lyrra | 19.00`)
  let [l, r] = text.split`|`
if (!l) l = ''
if (!r) r = ''
const avatar = await sock.profilePictureUrl(m.sender, "image").catch(() => 'https://files.catbox.moe/nwvkbt.png')
